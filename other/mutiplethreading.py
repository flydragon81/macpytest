...
from function.file_function import SpsParser
import pandas as pd
...
class Reader(threading.Thread):
    def __init__(self, file_name, start_pos, end_pos):
        ...
        self.parser = SpsParser.Sps21Parser()
...
class Partition(object):
    ...
    def part(self):
        ...
        pos_list = []
        file_size = fd.tell()
        block_size = file_size / self.block_num + 1
        start_pos = 0
...
if __name__ == '__main__':
    ...
    '''
    # 文件名
    file_name = '/Volumes/Data/Python/macpytest/data/mirfa.X'
    # config.get('info', 'fileName')
    # 线程数量
    thread_num = 5
    # int(config.get('info', 'threadNum'))
    # 起始时间
